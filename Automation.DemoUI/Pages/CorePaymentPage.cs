...
namespace Automation.DemoUI.Pages
{
    public class CorePaymentPage : TestBase, ICorePaymentPage
    {
        ...
        //IAtWebElement submitBtn2 => _idriver.FindElement(GetBy(LocatorType.CssSelector, ".ml-auto > .btn"));

        //IAtWebElement submitBtn1 => _idriver.FindElement(GetBy(LocatorType.Xpath, ".d-flex:nth-child(10) > .pr-2 > .btn"));
